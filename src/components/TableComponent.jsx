          ...
          <AppFlexBox justify="s">
            {selectedRow && (
              <>
                ...
                {/* ✅ Updated part: render view/update/delete only if active !== false */}
                {selectedRow.active !== false && (
                  <>
                    {showViewButton && (
                      <ButtonCustomizedAction
...
//     handleActive=(id) => console.log(`Active  clicked for row with ID: ${id}`),
...
// const hasFlags = selectedRow?.active      || selectedRow?.blocked || selectedRow?.deleted || selectedRow?.accountExpired || selectedRow?.accountLocked || selectedRow?.credentialsExpired;
//   return (
